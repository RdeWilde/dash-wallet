...
public final class BitcoinIntegration
{
	...
	private static final String MIMETYPE_PAYMENTREQUEST = "application/ion-paymentrequest"; // BIP 71
	...
	{
		final StringBuilder uri = new StringBuilder("ion:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No ion application found.\nPlease install ion Wallet.", Toast.LENGTH_LONG).show();

		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=ionomy.ion.wallet"));
		final Intent binaryIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/ionomy/ion-wallet/releases"));
